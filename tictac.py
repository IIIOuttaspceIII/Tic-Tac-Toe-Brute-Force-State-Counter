...
class Noughts_Solver:
    ...
    def solve(self):
        ...
        print(f"Found {len(self.states)} states or {math.ceil(math.log2(len(self.states)))} ({math.log2(len(self.states))}) bits")
    ...
    def try_add_new_state(self,board):
        ...
        if not self.is_board_saved(board):
            ...
            if len(self.states) % 100 == 0:
                print(f"{len(self.states)} or {math.ceil(math.log2(len(self.states)))} bits")
